  ...
  return (
    <div className="px-4 pb-16 text-center">
      ...
      <p className="mb-12 text-lg">
        Cam kết hoàn toàn bất kể quy mô đơn hàng. Cách tiếp cận này cho phép chúng tôi đáp ứng được
        kỳ vọng của ngay cả những khách hàng khó tính nhất.
      </p>
      <div className="flex-responsive justify-center gap-10 md:gap-8">
        <div className="basis-4/12">
          ...
          <p className="text-justify">
            Mạng lưới đối tác của chúng tôi trải dài từ các công ty vận tải, cơ quan hải quan, đối
            tác CNTT đến các nhà máy sản xuất và kho bãi.
          </p>
        </div>
        <div className="basis-4/12">
          <div className="relative mb-8">
          ...
          <p className="text-justify">
            Chúng tôi luôn đồng hành và linh hoạt theo nhu cầu của khách hàng, không áp đặt những
            khuôn mẫu sẵn có. Mỗi giải pháp chúng tôi tạo ra đều được &ldquo;may đo&rdquo; riêng
            biệt, phù hợp nhất với doanh nghiệp của khách hàng, chứ không phải vì sự tiện lợi của
            chúng tôi.
          </p>
        </div>
        <div className="basis-4/12">
          ...
          <p className="text-justify">
            Chúng tôi cung cấp giải pháp thiết kế chuỗi cung ứng toàn diện, tùy chỉnh theo từng nhu
            cầu của khách hàng. Chúng tôi lựa chọn phương thức vận chuyển, nhà vận tải tối ưu nhất,
