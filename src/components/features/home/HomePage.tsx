  ...
  return (
    <Box component="main" py={rem(100)} maw={rem(theme.other.maxApplicationWidth)} mx="auto">
      <Container>
        ...
        <Stack mt="xl">
          <Text>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. In earum placeat voluptatibus
            eligendi sint? Tenetur quibusdam praesentium assumenda nihil. Voluptate, consequatur.
            Delectus quasi sit labore consequuntur quae ex voluptatibus nostrum.
          </Text>
